...
class VideoRecorder(
  ...
  private fun CamcorderProfile.width(): Int =
    if (isLandscape()) videoFrameWidth else videoFrameHeight

  private fun CamcorderProfile.height(): Int =
    if (isLandscape()) videoFrameHeight else videoFrameWidth
}
