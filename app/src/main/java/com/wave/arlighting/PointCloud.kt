...
object PointCloud {
  ...
  private val UV_00 = Vertex.UvCoordinate(
    0.0f,
    0.0f
  )
  private val UV_10 = Vertex.UvCoordinate(
    1.0f,
    0.0f
  )
  private val UV_01 = Vertex.UvCoordinate(
    0.0f,
    1.0f
  )
  private val UV_11 = Vertex.UvCoordinate(
    1.0f,
    1.0f
  )
  ...
  fun makePointCloud(
    ...
    val submesh = RenderableDefinition.Submesh.builder().setMaterial(material)
      .setTriangleIndices(triangleIndices).build()
  ...
  private fun vertex(
    position: Vector3,
    normal: Vector3,
    uv: Vertex.UvCoordinate
  ): Vertex {
    return Vertex.builder().setPosition(position).setNormal(normal)
      .setUvCoordinate(uv).build()
  }
}